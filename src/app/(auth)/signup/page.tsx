    ...
    <div className="relative min-h-screen flex items-center justify-center p-6 overflow-hidden">
      ...
      <div className="relative w-full max-w-[420px] animate-fade-in">
        <div className="mb-8 text-center">
          ...
          <p className="mt-4 text-sm text-cerna-text-secondary">Your portfolio-aware analyst</p>
        </div>

        <form onSubmit={handleSubmit} className="rounded-2xl glass-elevated p-6 space-y-4">
        ...
        <p className="text-center mt-6 text-sm text-cerna-text-secondary">
          ...
          <Link href="/login" className="text-cerna-primary hover:underline">
            Sign in
          </Link>
        </p>
      </div>
